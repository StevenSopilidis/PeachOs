...
./build/task/process.o: ./src/task/process.c
	i686-elf-gcc $(INCLUDES) -I./src/process $(FLAGS) -std=gnu99 -c ./src/task/process.c -o ./build/task/process.o
