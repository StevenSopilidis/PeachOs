FILES = ./build/kernel.asm.o ./build/kernel.o ./build/disk/disk.o ./build/disk/stream.o ./build/task/process.o ./build/task/task.o ./build/task/task.asm.o ./build/task/tss.asm.o ./build/fs/pparser.o ./build/fs/file.o ./build/fs/fat/fat16.o ./build/string/string.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/io/io.asm.o ./build/gdt/gdt.o ./build/gdt/gdt.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.asm.o ./build/isr80h/isr80h.o ./build/isr80h/misc.o ./build/isr80h/io.o ./build/print/print.o ./build/keyboard/keyboard.o ./build/keyboard/ps2.o ./build/loader/formats/elfloader.o ./build/loader/formats/elf.o ./build/isr80h/heap.o ./build/isr80h/process.o
INCLUDES = -I./src
...
./build/print/print.o: ./src/print/print.c
	i686-elf-gcc $(INCLUDES) -I./src/print $(FLAGS) -std=gnu99 -c ./src/print/print.c -o ./build/print/print.o
